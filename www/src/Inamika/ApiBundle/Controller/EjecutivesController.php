...
use Inamika\BackEndBundle\Form\Ejecutive\ContactType;
...
{   
    public function indexAction(Request $request){
        ...
        return $this->handleView($this->view(array(
            'data' => $this->getDoctrine()->getRepository(Ejecutive::class)->search($query, $limit, $offset, $sort, $direction)->getQuery()->getResult(),
            'recordsTotal' => $this->getDoctrine()->getRepository(Ejecutive::class)->total(),
            'recordsFiltered' => $this->getDoctrine()->getRepository(Ejecutive::class)->searchTotal($query, $limit, $offset),
            'offset' => $offset,
            'limit' => $limit,
        )));
    }
    ...
    public function getAction($id){
        if(!$entity=$this->getDoctrine()->getRepository(Ejecutive::class)->find($id))
            return $this->handleView($this->view(null, Response::HTTP_NOT_FOUND));
        return $this->handleView($this->view($entity));
    }

    public function postAction(Request $request){
        $entity = new Ejecutive();
        $form = $this->createForm(EjecutiveType::class, $entity);
    ...
    public function importAction(Request $request){
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            try {
                $this->getDoctrine()->getRepository(Ejecutive::class)->import($path.$file);
                return $this->handleView($this->view("", Response::HTTP_OK));
            } catch (\Throwable $th) {
