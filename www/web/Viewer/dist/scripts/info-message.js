...
AFRAME.registerComponent('info-message', {
  ...
  addStyles: function () {
    var css =
      ...
      '.a-close-button-info{width: 30px; height: 30px; padding: 0;' +
      'top: 10px; right: 10px; position: absolute; color: white;' +
      'font-size: 12px; line-height: 12px; border: none; background: url(./assets/btn_close_off.png) 50% 50% no-repeat; background-size: 30px 30px;' +
      'font-weight: medium}' +

      '.a-close-button-info:hover{background: url(./assets/btn_close_on.png) 50% 50% no-repeat; background-size: 30px 30px;}' +
      '.a-info-message-container {position: absolute; top: 110px; right: 20px;}' +
      '.a-info-message-button {background: ' + this.infoMessageButtonDataURI + ' 50% 50% no-repeat; background-size: 40px;}' +
      '.a-info-message-button {border: 0; bottom: 0; cursor: pointer; min-width: 90px; min-height: 90px; padding-right: 0; padding-top: 0; position: absolute; right: 0; transition: background-color .05s ease; -webkit-transition: background-color .05s ease; z-index: 9999; border-radius: 8px; touch-action: manipulation;}' +
      '.a-info-message-button:active, .a-info-message-button:hover {background: url(./assets/btn_help_on.png) 50% 50% no-repeat}';
  ...
  infoMessageButtonDataURI: 'url(./assets/btn_help_off.png)'
